...
*/
	//outra forma de fazer é :	containing -aplica o like
	@Transactional(readOnly=true)
	Page<Produto> findDistinctByNomeContainingAndCategoriasIn( String nome, List<Categoria> categorias, Pageable linePerPage);
}
